...
class Seq2SeqAgent(BaseAgent):
    ...
    def rollout(self, train_ml=None, train_rl=True, reset=True):
        ...
        print("Seq2SeqAgent - Sentence")
        #print(sentence.shape)
        #for i in range(sentence.shape[0]):
        print(self.tok.convert_ids_to_tokens(sentence[0].detach().cpu().numpy()))
        #for i in sentence[0]:
        #    print(self.tok.decode_sentence[i])
